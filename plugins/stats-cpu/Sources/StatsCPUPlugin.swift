...
public final class StatsCPUPlugin: AlwmPlugin {
    ...
    public func barItem(placement: AlwmBarPlacement) -> NSView? {
        ...
        return CPUBarChipView(
            label: CPUStore.shared.barLabel,
            scale: scale,
            tooltip: CPUStore.shared.tooltip
        )
    }
...
private final class CPUBarChipView: NSView {
    ...
    override func mouseDown(with event: NSEvent) {
        Task { @MainActor in
            CPUPanelController.toggle(relativeTo: self)
        }
    }
