...
private final class SteamKeyPanel: NSPanel {
...
enum SteamPanelController {
    private static var window: SteamKeyPanel?
    ...
    static func open(anchoredTo geometry: PluginPanelAnchor.Geometry?) {
        let geo = geometry ?? PluginPanelAnchor.remembered(forPlugin: "dev.alwm.steam-price-watcher")
